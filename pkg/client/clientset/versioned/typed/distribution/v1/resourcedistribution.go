...
type ResourceDistributionsGetter interface {
	ResourceDistributions(namespace string) ResourceDistributionInterface
}
...
type ResourceDistributionInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*v1.ResourceDistributionList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ResourceDistribution, err error)
...
func newResourceDistributions(c *DistributionV1Client, namespace string) *resourceDistributions {
...
func (c *resourceDistributions) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ResourceDistribution, err error) {
...
func (c *resourceDistributions) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ResourceDistributionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ResourceDistributionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("resourcedistributions").
...
func (c *resourceDistributions) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resourceDistributions) Create(ctx context.Context, resourceDistribution *v1.ResourceDistribution, opts metav1.CreateOptions) (result *v1.ResourceDistribution, err error) {
	result = &v1.ResourceDistribution{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcedistributions").
...
func (c *resourceDistributions) Update(ctx context.Context, resourceDistribution *v1.ResourceDistribution, opts metav1.UpdateOptions) (result *v1.ResourceDistribution, err error) {
	result = &v1.ResourceDistribution{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcedistributions").
...
func (c *resourceDistributions) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *resourceDistributions) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *resourceDistributions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ResourceDistribution, err error) {
	result = &v1.ResourceDistribution{}
