...
func (c *WorkV1Client) ClusterResourceBindings() ClusterResourceBindingInterface {
	return newClusterResourceBindings(c)
}

func (c *WorkV1Client) ResourceBindings(namespace string) ResourceBindingInterface {
	return newResourceBindings(c, namespace)
}

func (c *WorkV1Client) Works(namespace string) WorkInterface {
