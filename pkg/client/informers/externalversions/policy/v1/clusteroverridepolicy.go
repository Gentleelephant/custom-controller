...
type ClusterOverridePolicyInformer interface {
	...
	Lister() v1.ClusterOverridePolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1().ClusterOverridePolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1().ClusterOverridePolicies().Watch(context.TODO(), options)
			},
		},
		&policyv1.ClusterOverridePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterOverridePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyv1.ClusterOverridePolicy{}, f.defaultInformer)
}

func (f *clusterOverridePolicyInformer) Lister() v1.ClusterOverridePolicyLister {
	return v1.NewClusterOverridePolicyLister(f.Informer().GetIndexer())
}
