	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.DistributionV1().Workloads(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DistributionV1().Workloads(namespace).Watch(context.TODO(), options)
			},
		},
		&distributionv1.Workload{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workloadInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&distributionv1.Workload{}, f.defaultInformer)
}
