	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DistributionV1alpha1().ResourceDistributions().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DistributionV1alpha1().ResourceDistributions().Watch(context.TODO(), options)
			},
		},
		&distributionv1alpha1.ResourceDistribution{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceDistributionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&distributionv1alpha1.ResourceDistribution{}, f.defaultInformer)
}
