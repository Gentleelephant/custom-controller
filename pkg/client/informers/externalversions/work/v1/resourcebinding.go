...
type ResourceBindingInformer interface {
	...
	Lister() v1.ResourceBindingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkV1().ResourceBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkV1().ResourceBindings(namespace).Watch(context.TODO(), options)
			},
		},
		&workv1.ResourceBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&workv1.ResourceBinding{}, f.defaultInformer)
}

func (f *resourceBindingInformer) Lister() v1.ResourceBindingLister {
	return v1.NewResourceBindingLister(f.Informer().GetIndexer())
}
