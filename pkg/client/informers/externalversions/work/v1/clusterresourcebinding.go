...
type ClusterResourceBindingInformer interface {
	...
	Lister() v1.ClusterResourceBindingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkV1().ClusterResourceBindings().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkV1().ClusterResourceBindings().Watch(context.TODO(), options)
			},
		},
		&workv1.ClusterResourceBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterResourceBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&workv1.ClusterResourceBinding{}, f.defaultInformer)
}

func (f *clusterResourceBindingInformer) Lister() v1.ClusterResourceBindingLister {
	return v1.NewClusterResourceBindingLister(f.Informer().GetIndexer())
}
