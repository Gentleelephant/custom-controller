...
//}
//
//func NewController(k8sClient kubernetes.Interface, cli client.Client, ctrlcache ctrlcache.Cache) *Controller {
...
//		Client:    cli,
//		ctrlcache: ctrlcache,
//		workqueue: workqueue.NewNamedRateLimitingQueue(workqueue.DefaultControllerRateLimiter(), "policy-controller"),
//		recorder:  recorder,
//	}
//
//	return controller
