...
//		if !controllerutil.ContainsFinalizer(w, DistributionFinalize) {
//			w.ObjectMeta.Finalizers = append(w.ObjectMeta.Finalizers, DistributionFinalize)
...
//			controllerutil.RemoveFinalizer(w, DistributionFinalize)
//			if err := r.Update(context.Background(), w); err != nil {
//				return ctrl.Result{}, err
//			}
//		}
